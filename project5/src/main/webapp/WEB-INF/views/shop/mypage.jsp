...
<body>
	...
	<div id="contents" style="padding: 0 0 50px;">
		...
		<ul class="mypage_tab"><li class="home on"><a href="/myshop/index.html" class="fs15">홈</a></li>
		...
		</ul><div class="xans-element- xans-myshop xans-myshop-asyncbenefit page_wrap"><div class="ec-base-box typeMember gMessage displaynone">
